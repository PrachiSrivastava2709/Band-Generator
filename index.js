...
app.post("/submit", async (req, res) => {
  ...
  let adjIndex = await getRandomInt(0, adj.length);
  let nounIndex = await getRandomInt(0, noun.length);
  const bandName = capitalizeFirstLetter(adj[adjIndex]) + " " + capitalizeFirstLetter(noun[nounIndex]);
